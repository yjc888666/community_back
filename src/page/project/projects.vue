    ...
    <div>
        <div class="layui-field-box"  v-show="menuShow">
            <div class="layui-box-searchber">
                <a href="javascript:;"  class="layui-btn layui-btn-sm" @click="addEvent" v-show="chang('/master/project/set')"><i class="layui-icon"></i> 添加项目</a>
            ...
            <table class="layui-table admin-table">
                ...
                <tr>
                    ...
                    <th align="center">项目标题</th>
                    <th width="60px" style="text-align:center">负责人</th>
                    <th width="60px" style="text-align:center">状态</th>
                    <th width="70px" style="text-align:center">开启时间</th>
                    <th width="70px" style="text-align:center">开发时间</th>
                    <th width="70px" style="text-align:center">预期开发时间</th>
                    <th width="70px" style="text-align:center">项目进度</th>
                ...
                <tr v-for="(item,index) in forumList.list" :key="index">
                    ...
                    <td>
                        <el-switch
                            ...
                            on-color="#5FB878"
                            off-color="#ccc"
                            @change="changeSwitch(item.id,item.status)"
                        >
                        </el-switch>
                    ...
                    <td align="center">
                        <a class="layui-btn layui-btn-normal layui-btn-sm" href="javascript:;" @click="editEvent(item.id)" v-show="chang('/master/project/edit')">修改</a>
                        ...
                        <a class="layui-btn layui-btn-normal layui-btn-danger layui-btn-sm" href="javascript:;" @click="joinEvent(item.id)" v-show="chang('/master/project/add')">加入</a>
                        <a class="elementdel layui-btn  layui-btn-sm" href="javascript:;" @click="removeEvent(item.id)" v-show="chang('/master/project/remove')">移除</a>
                        <a class="layui-btn layui-btn-normal  layui-btn-sm" href="javascript:;" @click="settingEvent(item.id)" v-show="chang('/master/project/responsible')">负责人</a>
                    </td>
                </tr>
                </tbody>
            </table>
                        ...
                        <el-form :model="ruleFormAdd" status-icon :rules="rulesAdd" ref="ruleFormAdd" label-width="100px" class="demoBtn-ruleForm">
                            ...
                            <div class="layui-form-item">
                                <el-form-item label="项目名称" prop="name">
                                    <el-input v-model="ruleFormAdd.name" placeholder="请输入项目名称"></el-input>
                                </el-form-item>
                            </div>
                            <div class="btable-paged">
                                <div class="layui-main">
                                    <div class="formbtngroup">
                                        <el-form-item>
                                            <el-button type="primary" @click="submitFormAdd('ruleFormAdd')" v-show="chang('/master/project/set')">添加</el-button>
                ...
                <div class="layui-tab-item layui-show">
                    <div class="layui-form form-container">
                        <el-form :model="ruleFormEdit" status-icon :rules="rulesEdit" ref="ruleFormEdit" label-width="100px" class="demoBtn-ruleForm">
                            ...
                            <div class="layui-form-item">
                                <el-form-item label="项目名称" prop="name">
                                    <el-input v-model="ruleFormEdit.name" placeholder="请输入项目名称"></el-input>
                                </el-form-item>
                            </div>
                            <div class="btable-paged">
                                <div class="layui-main">
                                    <div class="formbtngroup">
                                        <el-form-item>
                                            <el-button type="primary" @click="submitFormEdit('ruleFormEdit')" v-show="chang('/master/project/edit')">更新</el-button>
        ...
        <div class="layui-field-box" v-show="joinShow">
            <button class="layui-btn layui-btn-sm"  @click="joinAllEvent" >全部加入</button>
            <table class="layui-table admin-table">
                <thead>
                <tr>
            ...
            <div class="btable-paged">
                <div class="layui-main">
                    <div class="formbtngroup">
                        <el-button type="primary" @click="submitFormJoin" v-show="chang('/master/project/add')">加入</el-button>
        ...
        <div class="layui-field-box" v-show="removeShow">
            <button class="layui-btn layui-btn-sm"  @click="removeAllEvent" >全部移除</button>
            <table class="layui-table admin-table">
                <thead>
                <tr>
            ...
            <div class="btable-paged">
                <div class="layui-main">
                    <div class="formbtngroup">
                        <el-button type="primary" @click="submitFormRemove" v-show="chang('/master/project/remove')">移除</el-button>
                        <el-button @click="resetForm">返回</el-button>
                    </div>
                </div>
            </div>
                        ...
                        <el-form :model="ruleFormSet" status-icon :rules="rulesSet" ref="ruleFormSet" label-width="100px" class="demoBtn-ruleForm">
                            ...
                            <div class="btable-paged">
                                <div class="layui-main">
                                    <div class="formbtngroup">
                                        <el-form-item>
                                            <el-button type="primary" @click="submitFormSet('ruleFormSet')" v-show="chang('/master/project/responsible')">设置负责人</el-button>
...
//                console.log('editor ready!', editor)
            ...
            del(){
                var me=this;
                me.$axios.post(me.url+"master/project/batchdel",me.checkModel)
                    .then(function (result) {
            ...
            delEvent(id){
                var me=this;
                me.$axios.post(me.url+"master/project/del?id="+id)
                    .then(function (result) {
                        if(result.data.result==false){
                            me.$message({
                                message: result.data.msg,
            ...
            forumEvent(){
                ...
                me.$axios.post(me.url+"master/project/bypage",para)
                    .then(function (result) {
                        console.log(result)
            ...
            changeSwitch(id,status){
                var me=this;
                me.$axios.post(me.url+"master/project/switch?id="+id)
                    .then(function (result) {
                        if(result.data.result==true){
            ...
            editEvent(id){
                ...
                this.editShow=true;
                var me = this;
                me.$axios.post(me.url+"master/project/get?id="+id)
                    .then(function (result) {
                        if(result.data.result==true){
            ...
            submitFormAdd(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        me.$axios.post(me.url+"master/project/set",para)
                            .then(function (result) {
                                if(result.data.result==false){
                                    me.$message({
                                        message: result.data.msg,
            ...
            submitFormEdit(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        me.$axios.post(me.url+"master/project/edit",para)
                            .then(function (result) {
                                if(result.data.result==false){
                                    me.$message({
                                        message: result.data.msg,
            ...
            submitFormJoin() {
                ...
                var para = {
                    id:this.joinId,
                    modid:this.checkModelJoin
                };
                me.$axios.post(me.url+"master/project/join",para)
                    .then(function (result) {
                        if(result.data.result==false){
                            me.$message({
                                message: result.data.msg,
            ...
            submitFormRemove() {
                ...
                var para = {
                    id:this.removeId,
                    modid:this.checkModelRemove
                };
                me.$axios.post(me.url+"master/project/remove",para)
                    .then(function (result) {
                        if(result.data.result==false){
                            me.$message({
                                message: result.data.msg,
            ...
            submitFormSet() {
                ...
                var para = {
                    id:this.setId,
                    responsible:this.ruleFormSet.developers
                };
                me.$axios.post(me.url+"master/project/responsible",para)
                    .then(function (result) {
                        if(result.data.result==false){
                            me.$message({
                                message: result.data.msg,
...
//            加入列表
            joinEvent(id){
                ...
                me.$axios.post(me.url+"master/project/joinlist",para)
                    .then(function (result) {
//                       console.log(result)
            ...
            removeEvent(id){
                ...
                me.$axios.post(me.url+"master/project/removelist",para)
                    .then(function (result) {
//                       console.log(result)
