    ...
    <div>
        <div class="layui-field-box"  v-show="menuShow">
                <div class="layui-box-searchber">
                    <button class="layui-btn layui-btn-sm"  @click="delAllEvent" v-show="chang('/master/activity/delete')">删除选中</button>
                ...
                <table class="layui-table admin-table">
                    ...
                    <tr>
                        ...
                        <th width="80px" style="text-align:center">开始日期</th>
                    ...
                    <tr v-for="(item,index) in forumList.list" :key="index">
                        ...
                        <td align="center"><a target="_blank" href="javascript:;">{{item.start_time}}</a></td>
                        <td align="center">{{item.end_time}}</td>
                        <td align="center">{{item.add_time}}</td>
                        <td align="center">
                            <a class="layui-btn layui-btn-normal layui-btn-sm" href="javascript:;" @click="editEvent(item.id)"  v-show="chang('/master/activity/edit')">修改</a>
                            <a class="elementdel layui-btn layui-btn-danger layui-btn-sm" href="javascript:;" @click="delEvent(item.id)"  v-show="chang('/master/activity/delete')">删除</a>
                        </td>
                    </tr>
                    </tbody>
                </table>
                        ...
                        <el-form :model="ruleFormEdit" status-icon :rules="rulesEdit" ref="ruleFormEdit" label-width="100px" class="demoBtn-ruleForm">
                            ...
                            <div class="layui-form-item">
                                <el-form-item label="积分" prop="score">
                                    <el-input v-model="ruleFormEdit.score" placeholder="请输入积分" type="number"></el-input>
                                </el-form-item>
                            </div>
                            <div class="btable-paged" v-show="chang('/master/activity/edit')">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            del(){
                var me=this;
                me.$axios.post(me.url+"master/activity/delete",me.checkModel)
                    .then(function (result) {
            ...
            delEvent(id){
                var me=this;
                me.$axios.post(me.url+"master/activity/delete",[id])
                    .then(function (result) {
                        if(result.data.result==false){
                            me.$message({
                                message: result.data.msg,
            ...
            forumEvent(){
                var me=this;
                me.$axios.post(me.url+"master/activity/list?page=" + this.pageNum + "&size=" + this.pageSize+ "&open=" + this.open+"&start_time=" + this.beginValue+"&end_time=" + this.endValue+"&choice=" + this.choice+"&settop=" + this.settop+"&memo=" + this.memo+"&keywords=" + this.keyword)
                    .then(function (result) {
            ...
            editEvent(id){
                ...
                this.editShow=true;
                var me = this;
                me.$axios.post(me.url+"master/activity/get?id="+id)
                    .then(function (result) {
                        console.log(result)
                        if(result.data.result==true){
                            ...
                            me.ruleFormEdit.score=result.data.pojo.score;
                            me.startTime=result.data.pojo.start_time;
                            me.endTime=result.data.pojo.end_time;
                        }
                    })
                    .catch(function (error) {
                        console.log(error);
            ...
            changeSwitch(open,settop,choice,memo,id){
                ...
                me.$axios.post(me.url+"master/activity/open",para)
                    .then(function (result) {
                        if(result.data.result==false){
                            me.$message({
                                message: result.data.msg,
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        var para = {
                            ...
                            score: this.ruleFormEdit.score,
                            content: this.zldata.info,
                        };
                        me.$axios.post(me.url+"master/activity/edit",para)
                            .then(function (result) {
                                if(result.data.result==false){
                                    me.$message({
                                        message: result.data.msg,
