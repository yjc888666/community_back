            ...
            <div class="layui-field-box">
                ...
                <table class="layui-table admin-table">
                    ...
                    <tr>
                        ...
                        <th align="center">附件上传时间</th>
                        <th align="center">附件过期时间</th>
                        <th align="center">附件下载次数</th>
                    ...
                    <tr v-for="(item,index) in signList" :key="index">
                        ...
                        <td>{{item.create_time}}</td>
                        <td>{{item.download}}次</td>
                        <td>{{item.score}}分</td>
                        <td>
                            <a href="javascript:;"  class="elementdel layui-btn layui-btn-danger layui-btn-sm" @click="delEvent(item.id)"  v-show="chang('/master/forum/delfile')">删除</a>
                        </td>
                    </tr>
...
//           权限的接口
            ...
            delEvent(id){
                var me=this;
                me.$axios.post(me.url+"master/forum/delfile?id="+id)
                    .then(function (result) {
            ...
            signEvent(){
                var me=this;
                me.$axios.post(me.url+"master/forum/uppage?page=" + this.pageNum + "&size=" + this.pageSize+ "&status=" + this.status)
                    .then(function (result) {
