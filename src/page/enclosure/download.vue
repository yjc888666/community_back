            ...
            <div class="layui-field-box">
                ...
                <table class="layui-table admin-table">
                    ...
                    <tr v-for="(item,index) in signList" :key="index">
                        ...
                        <td>{{item.filesize}}</td>
                        <td>{{item.time}}</td>
                        <td>{{item.invalibtime}}</td>
                        <td>{{item.score}}分</td>
                        <td>
                            <a href="javascript:;"  class="elementdel layui-btn layui-btn-danger layui-btn-sm" @click="delEvent(item.id)"  v-show="chang('/master/forum/delrecord')">删除</a>
                        </td>
                    </tr>
...
//           权限的接口
            ...
            delEvent(id){
                var me=this;
                me.$axios.post(me.url+"master/forum/delrecord?id="+id)
                    .then(function (result) {
            ...
            signEvent(){
                var me=this;
                me.$axios.post(me.url+"master/forum/bypage?page=" + this.pageNum + "&size=" + this.pageSize)
                    .then(function (result) {
