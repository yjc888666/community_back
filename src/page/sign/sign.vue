                ...
                <div class="layui-box-searchber">
                    ...
                    <form class="layui-form layui-form-pane">
                        ...
                        <div class="layui-inline" >
                            <div @click="daoEvent()" class="dao" v-if="chang('/master/sign/signExcels')">导出</div>
                        </div>
...
//            签到管理
                me.$axios.post(me.url+"master/sign/list",para)
                    .then(function (result) {
...
//           年
            ...
            daoEvent(){
                ...
                if(me.signList.length ==0||me.signList.length ==undefined){
                    ...
                    me.$axios({ 
                        method: 'post',
                        url: me.url+"/master/sign/signExcels", 
                        data:{
                            username:this.username,
                            year:this.valueYear,
                            month :this.valueMonth
